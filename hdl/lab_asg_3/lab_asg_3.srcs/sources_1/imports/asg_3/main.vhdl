...
/*
 The output split will not be done here, but in the higher level entity that calls this model, to maintain generality.
 Said so, the output will be of length w-1, instead of having 2 different outputs.
 */
entity counter is
    generic (
        MAX_COUNT_g : integer;
