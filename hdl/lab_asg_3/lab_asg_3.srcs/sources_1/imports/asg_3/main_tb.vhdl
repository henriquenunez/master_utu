...
architecture rtl of main_tb is
    ...
    signal count_h, count_l : std_logic_vector(3 downto 0);
...
begin
    uut: counter
        ...
        port map (
            ...
            up_down => up_down,
            data    => data,
            count(3 downto 0)   => count_l,
            count(7 downto 4)   => count_h,
            over    => over
        );
    ...
    begin
	   ...
	   wait for 10 ns;
        ...
        assert count_l = "0000" and count_h = "0000" and over = '0'
            report "unable to reset! " & to_hstring(count_l) severity error;
...
--            end if;
        ...
        clock <= '1';
        wait for 10 ns;
        assert count_l = "1010" and over = '0' report "cannot load!" severity error;
